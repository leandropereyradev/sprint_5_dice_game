...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NoPlayersWithWinRateException.class)
    public ResponseEntity<String> handleNoPlayersWithPositiveWinRateException(NoPlayersWithWinRateException ex) {
